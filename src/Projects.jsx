        ...
        <div className='projects' >
            ...
            <div className="full_container blue-container">
                ...
                <div className="pro_image">
                    <div className="frame">
                        <img src="assets\Screenshot (7).png" alt="Project Screenshot"/>
                    </div>
            ...
            <div className="full_container grey-container">
                ...
                <div className="pro_image">
                    <div className="frame">
                        <img src="assets\Billing.png" alt="Project Screenshot"/>
                    </div>
                    <div className="shelf-bar"></div>
                </div>
            </div>
            <div className="full_container">
                ...
                <div className="pro_image">
                    <div className="frame">
                        <img src="assets\speedtyping.png" alt="Project Screenshot"/>
                    </div>
                    <div className="shelf-bar"></div>
                </div>
            </div>
